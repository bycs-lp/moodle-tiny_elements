...
/**
 * Form for bulk editing displaynames
 *
 ...
 */
class management_displaynames_form extends dynamic_form {
    /**
     * Form definition
     */
    public function definition() {
        global $DB;
        $count = $DB->count_records('tiny_elements_component');
        $mform =& $this->_form;
    ...
    public function process_dynamic_submission(): array {
        ...
        foreach ($formdata->id as $key => $id) {
            ...
            $result &= $DB->update_record('tiny_elements_component', $record);
        }
    ...
    public function set_data_for_dynamic_submission(): void {
        ...
        $data['itemcount'] = count($components);
